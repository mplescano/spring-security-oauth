...
public class JwtJdbcTokenConverterTests {
    ...
    public void testRefreshTokenAdded() throws Exception {
        ...
        assertEquals("refresh_token", refreshClaims.get(JwtJdbcTokenConverter.TOKEN_TYPE));
        assertEquals("BAR", refreshClaims.get(AccessTokenConverter.JTI));
        assertEquals("FOO", accessClaims.get(AccessTokenConverter.JTI));
        assertEquals("BAR", accessClaims.get(JwtJdbcTokenConverter.REFRESH_TOKEN_ID));
    ...
    public void testRefreshTokenAccessTokenIdWhenDoubleEnhanced() throws Exception {
        ...
        assertEquals("refresh_token", claims.get(JwtJdbcTokenConverter.TOKEN_TYPE));
